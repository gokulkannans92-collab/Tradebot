...
class MockBroker(Broker):
    def __init__(self):
        ...
        self.is_connected = True # Signals that get_quote is ready
    ...
    def get_quote(self, symbol: str) -> Dict:
        ...
        _log.debug(f"[SIM] {symbol} spot = ₹{simulated:.2f} (simulated — API unavailable)")
    ...
    def get_balance(self) -> float:
        ...
        return 1000000.0  # ₹10 Lakhs mock balance

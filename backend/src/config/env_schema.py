...
class EnvSchema:
    ...
    SCHEMA: Dict[str, Dict[str, Any]] = {
        ...
        "ANGEL_API_KEY": {"type": str, "default": None},
        "ANGEL_API_SECRET": {"type": str, "default": None},
        "ANGEL_CLIENT_ID": {"type": str, "default": None},
        "ANGEL_CLIENT_SECRET": {"type": str, "default": None},
        "ZERODHA_API_KEY": {"type": str, "default": None},
        "ZERODHA_API_SECRET": {"type": str, "default": None},
        "ZERODHA_ACCESS_TOKEN": {"type": str, "default": None},
        "UPSTOX_API_KEY": {"type": str, "default": None},
        "UPSTOX_API_SECRET": {"type": str, "default": None},
        "UPSTOX_ACCESS_TOKEN": {"type": str, "default": None},
    ...
    def get_value(cls, var_name: str, default: Any = None) -> Any:
        ...
        if value is None:
            value = default if default is not None else schema.get("default")
            if value is None:
                return None
            # Cast the default value if it's a string
